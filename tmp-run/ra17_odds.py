...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra17_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra17_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 17)
REMAINING, DAYS_LEFT = 19134, 14    # uit api_check.py van vanochtend (866 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra17_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
