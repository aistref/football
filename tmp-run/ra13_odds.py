...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra13_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra13_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 13)
REMAINING, DAYS_LEFT = 19310, 18    # uit api_check.py van vanochtend (690 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra13_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
