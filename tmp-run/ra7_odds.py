...
DAY = date(2026, 9, 7)
REMAINING, DAYS_LEFT = 19625, 24    # uit api_check.py van vanochtend (375 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra7_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
