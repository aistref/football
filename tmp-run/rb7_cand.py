"""Run B, 7 sep 2026 — Stage 3 vervolg: tier per wedstrijd.

Gelijk aan `ra7_cand.py`; er zitten geen bekercompetities in de Run B-lijst, dus de
...
json.dump(cands, open("tmp-run/rb7_cands.json", "w"), ensure_ascii=False, indent=1)
