"""Run A, 23 sep 2026 — tweede bron bij een lege dag (§3 Stage 1: 'probeer meerdere bronnen').
...
DAY = date(2026, 9, 23)
URLS = json.load(open("tmp-run/ra23_stage3.json"))
CHECK = {
...
json.dump(out, open("tmp-run/ra23_bevestiging.json", "w"), ensure_ascii=False, indent=1)
