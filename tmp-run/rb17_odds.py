"""Run B — Stage 3 vervolg: prijzen inkopen (§1a, bulk met h2h erbij sinds 5 sep 2026).
...
doorgerekend. Dit script koopt daarom alleen de bulk; `rb17_btts.py` doet de tweede ronde op basis
van de uitkomst van `rb17_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 17)
REMAINING, DAYS_LEFT = 19122, 14    # uit api_check.py van deze run (878 gebruikt deze maand)
...
json.dump(store, open("tmp-run/rb17_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
