...
Ongewijzigd ten opzichte van 11 sep. Geen Europees duel op de kalender vandaag, dus de
kruis-grenstak komt niet aan bod; wat er wel langskomt zijn de binnenlandse omrekeningen voor
ploegen die niet in de stand van 2025/2026 van hun huidige divisie staan.
"""
import json, sys
...
for name, v in fx.items():
    ...
    for m in v["matches"]:
        ...
        # 16 sep 2026 — de basis per WEDSTRIJD in plaats van per beker (openstaand punt 1 van
...
json.dump(cands, open("tmp-run/ra16_cands.json", "w"), ensure_ascii=False, indent=1)
