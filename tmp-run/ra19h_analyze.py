"""Stage 5 — analyse Run A 18 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
odds = json.load(open("tmp-run/ra19h_odds.json"))
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/ra19h_results.json", "w"), ensure_ascii=False, indent=1)
