"""Run B, 13 sep 2026 — Stage 1/2/3: fixtures, competitiepoort, bronprobe + datadekking.
...
import rb13_retry  # noqa: F401  — eenmalige herhaalpoging bij een TLS-hik
...
json.dump({"fixtures": out, "stats": stats, "understat": {}},
          open("tmp-run/rb13_stage3.json", "w"), ensure_ascii=False, indent=1)
