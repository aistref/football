...
`rb26_analyze.py`): nooit krapper dan voorheen, en de reeks van §5a wordt er scherper van.
...
store = json.load(open("tmp-run/rb26_odds.json"))
res = json.load(open("tmp-run/rb26_results.json"))
cands = {c["match_id"]: c for c in json.load(open("tmp-run/rb26_ctx.json"))}
