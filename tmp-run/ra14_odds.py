...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra14_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra14_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 14)
REMAINING, DAYS_LEFT = 19232, 17    # uit api_check.py van vanochtend (768 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra14_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
