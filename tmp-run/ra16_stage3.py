"""Run A, 16 sep 2026 — Stage 1/2/3: fixtures, competitiepoort, bronprobe + datadekking.

Ongewijzigd ten opzichte van 11 sep: dezelfde 21 competities, dezelfde Fotmob-ids, en de drie
Europese toernooien als kruis-grens gemarkeerd (§4 "Kruis-grens", 8 sep 2026) in plaats van blind
op NONE — `scripts/interleague.py` rekent beide ploegen om naar de Europese schaal.
"""
import json
...
json.dump({"fixtures": out, "stats": stats, "understat": us_data},
          open("tmp-run/ra16_stage3.json", "w"), ensure_ascii=False, indent=1)
