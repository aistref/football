"""Run B, 20 sep 2026 — Stage 3 vervolg: tier per wedstrijd, met promovendi-/degradantenomrekening.

Zelfde regels als `ra20_cand.py`, zonder de kruis-grenstak en zonder de bekerlogica: de runlijst
...
json.dump(cands, open("tmp-run/rb20_cands.json", "w"), ensure_ascii=False, indent=1)
