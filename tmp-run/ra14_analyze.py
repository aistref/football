"""Stage 5 — analyse Run A 14 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
kandidaat-edge tonen"; `ra14_btts.py` koopt daarna in en deze analyse draait opnieuw, nu met de
...
cands = json.load(open("tmp-run/ra14_ctx.json"))
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/ra14_results.json", "w"), ensure_ascii=False, indent=1)
