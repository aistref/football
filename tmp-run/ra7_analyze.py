"""Stage 5 — analyse Run A 7 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
cands = json.load(open("tmp-run/ra7_ctx.json"))
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/ra7_results.json", "w"), ensure_ascii=False, indent=1)
