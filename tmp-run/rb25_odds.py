"""Run B, 25 sep 2026 — Stage 3 vervolg: prijzen inkopen (§1a, bulk met h2h erbij).

Twee competities spelen vandaag; alleen Segunda División heeft een sportkey bij The Odds API.
De Keuken Kampioen Divisie heeft er geen en draait dus op het gratis BetExplorer-marktgemiddelde,
precies de terugval die §1a voor competities zonder sportkey voorschrijft.
...
DAY = date(2026, 9, 25)
REMAINING, DAYS_LEFT = 18719, 6    # api_check.py van deze run: 1281 verbruikt deze maand
...
json.dump(store, open("tmp-run/rb25_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
