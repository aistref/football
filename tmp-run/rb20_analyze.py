"""Stage 5 — analyse Run B 20 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
PROMO_COMP = {
    ...
    # Run B, 20 sep 2026: geen beker maar een NAAMVERSCHIL. De runlijst van `prompts/run-b.md`
...
cands = json.load(open("tmp-run/rb20_ctx.json"))
...
def _netto(o, book):
    ...
    Tot 20 sep 2026 deed alleen de h2h-tak dit. Spreads, totals en BTTS gaven de BRUTO koers
...
for c in cands:
    ...
    if best_h2h:
        ...
        row["markets_checked"]["1X2"] = (f"geen h2h in de bulk-respons — teruggevallen op het "
    ...
    if ev_sp is None:
        ...
        for (outcome, line), (o_bruto, book) in lines.items():
            ...
            ln = float(line)
            # §1a: "Reken ALTIJD met oddsapi.net_price." Tot 20 sep 2026 gebeurde dat alleen in
    ...
    for markt, oms, o, bron, side, f in sel:
        ...
        rb = None
        # 20 sep 2026 — poort 6 moet óók draaien voor kandidaten die de drempel niet halen.
        ...
        # afzonderlijk na te lopen zijn; vandaar deze kaart. (20 sep 2026: zonder haar stond
    ...
    if passed:
        ...
        if near:
            ...
            # 20 sep 2026 — de derde mogelijkheid die hier tot vandaag niet bestond. `gate` was
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/rb20_results.json", "w"), ensure_ascii=False, indent=1)
