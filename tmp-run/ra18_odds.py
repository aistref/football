...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra18_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra18_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 18)
REMAINING, DAYS_LEFT = 19119, 13    # uit api_check.py van vanochtend (881 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra18_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
