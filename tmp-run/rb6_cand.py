"""Run B, 6 sep 2026 — Stage 3 vervolg: tier per wedstrijd.

Gelijk aan `ra6_cand.py`; er zitten geen bekercompetities in de Run B-lijst, dus de
...
json.dump(cands, open("tmp-run/rb6_cands.json", "w"), ensure_ascii=False, indent=1)
