"""Run B, 19 sep 2026 — Stage 1/2/3: fixtures, competitiepoort, bronprobe + datadekking.

Zelfde vorm als tmp-run/ra18_stage3.py, met de runlijst van prompts/run-b.md (17 competities).
...
json.dump({"fixtures": out, "stats": stats},
          open("tmp-run/rb19_stage3.json", "w"), ensure_ascii=False, indent=1)
