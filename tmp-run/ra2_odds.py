...
DAY = date(2026, 9, 2)
REMAINING, DAYS_LEFT = 19961, 29    # uit api_check.py van vanochtend; verse maand

cands = json.load(open("tmp-run/ra2_ctx.json"))
comps = []
for c in cands:
...
json.dump(store, open("tmp-run/ra2_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n", guard.report())
