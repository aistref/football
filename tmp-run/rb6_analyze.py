"""Stage 5 — analyse Run B 6 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
cands = json.load(open("tmp-run/rb6_ctx.json"))
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/rb6_results.json", "w"), ensure_ascii=False, indent=1)
