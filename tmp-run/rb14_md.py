"""Run B, 14 sep 2026 — het markdown-runrapport opbouwen uit data/run-state/.
...
6. **Run A van vanochtend noteert BTTS verkeerd in `markets_checked`.** Sinds vandaag koopt de
   ...
   `rb14_analyze.py` is het vandaag gerepareerd (met de reden en het onbenutte plafond erbij); de
