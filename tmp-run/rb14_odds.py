"""Run B, 14 sep 2026 — Stage 3 vervolg: prijzen inkopen (§1a, bulk met h2h erbij).

BTTS staat hier NIET meer bij: sinds 14 sep 2026 koopt `rb14_btts.py` die markt in een
...
DAY = date(2026, 9, 14)
REMAINING, DAYS_LEFT = 19207, 17    # uit api_check.py van deze run (793 gebruikt deze maand)
