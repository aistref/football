"""Run A, 26 sep 2026 — tweede bron bij een lege dag (§3 Stage 1: 'probeer meerdere bronnen').
...
DAY = date(2026, 9, 26)
URLS = json.load(open("tmp-run/ra26_stage3.json"))
CHECK = {
...
json.dump(out, open("tmp-run/ra26_bevestiging.json", "w"), ensure_ascii=False, indent=1)
