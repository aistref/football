...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra15_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra15_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 15)
REMAINING, DAYS_LEFT = 19197, 16    # uit api_check.py van vanochtend (768 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra15_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
