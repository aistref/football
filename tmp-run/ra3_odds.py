...
DAY = date(2026, 9, 3)
REMAINING, DAYS_LEFT = 19919, 28    # uit api_check.py van vanochtend (81 gebruikt deze maand)

cands = json.load(open("tmp-run/ra3_ctx.json"))
comps = []
for c in cands:
...
json.dump(store, open("tmp-run/ra3_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n", guard.report())
