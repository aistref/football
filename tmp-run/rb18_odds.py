...
doorgerekend. Dit script koopt daarom alleen de bulk; `rb18_btts.py` doet de tweede ronde op basis
van de uitkomst van `rb18_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 18)
REMAINING, DAYS_LEFT = 19081, 13    # uit api_check.py van deze run (919 gebruikt deze maand)
...
json.dump(store, open("tmp-run/rb18_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
