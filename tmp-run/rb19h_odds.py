...
doorgerekend. Dit script koopt daarom alleen de bulk; `rb19_btts.py` doet de tweede ronde op basis
van de uitkomst van `rb19_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 19)
REMAINING, DAYS_LEFT = 18920, 12    # na de herdraai van Run A
...
json.dump(store, open("tmp-run/rb19h_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
