...
doorgerekend. Dit script koopt daarom alleen de bulk; `ra16_btts.py` doet de tweede ronde op basis
van de uitkomst van `ra16_analyze.py`. Welke schaal "kandidaat-edge" is, staat daar beschreven.
"""
import json, sys
...
DAY = date(2026, 9, 16)
REMAINING, DAYS_LEFT = 19153, 15    # uit api_check.py van vanochtend (768 gebruikt deze maand)
