"""Stage 5 — analyse Run B 18 sep 2026. Beide methodes, alle zes markten, acht poorten.
...
# Vijf van de vijftien competities die vandaag spelen hebben géén xG bij Fotmob (Czech First
# League, Croatian HNL, Romanian SuperLiga, Keuken Kampioen Divisie, Kategoria Superiore), dus
# voor die competities bestaat de gebruikelijke observatie `(avg_xg vorig, avg_xg dit,
...
def league_ctx(comp, pid, season, season_cur=None):
    if comp not in league_cache:
        ...
        # Vijf van de vijftien competities die vandaag spelen hebben geen xG bij Fotmob. Het
...
json.dump({"vroeg_seizoen": {"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD,
          ...
          open("tmp-run/rb18_results.json", "w"), ensure_ascii=False, indent=1)
