...
DAY = date(2026, 9, 26)
REMAINING, DAYS_LEFT = 18707, 5    # api_check.py van deze run: 1293 verbruikt deze maand
...
json.dump(store, open("tmp-run/rb26_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
