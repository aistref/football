"""Run B, 7 sep 2026 — Stage 3 vervolg: prijzen inkopen (§1a, bulk met h2h erbij).
...
DAY = date(2026, 9, 7)
REMAINING, DAYS_LEFT = 19597, 24    # uit api_check.py van deze run (403 gebruikt deze maand)
...
json.dump(store, open("tmp-run/rb7_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
