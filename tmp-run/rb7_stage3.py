"""Run B, 7 sep 2026 — Stage 1/2/3: fixtures, competitiepoort, bronprobe + datadekking.

Zelfde opzet als `ra7_stage3.py` van vanochtend, met twee verschillen die bij Run B horen:
...
json.dump({"fixtures": out, "stats": stats, "understat": {}},
          open("tmp-run/rb7_stage3.json", "w"), ensure_ascii=False, indent=1)
