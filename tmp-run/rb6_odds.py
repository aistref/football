"""Run B, 6 sep 2026 — Stage 3 vervolg: prijzen inkopen (§1a, bulk met h2h erbij).
...
DAY = date(2026, 9, 6)
REMAINING, DAYS_LEFT = 19671, 25    # uit api_check.py van deze run (329 gebruikt deze maand)
...
json.dump(store, open("tmp-run/rb6_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
