...
DAY = date(2026, 9, 9)
REMAINING, DAYS_LEFT = 19550, 22    # uit api_check.py van vanochtend (450 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra9_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
