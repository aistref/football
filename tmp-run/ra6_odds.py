...
DAY = date(2026, 9, 6)
REMAINING, DAYS_LEFT = 19749, 25    # uit api_check.py van vanochtend (251 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra6_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
