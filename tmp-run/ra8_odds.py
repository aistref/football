...
DAY = date(2026, 9, 8)
REMAINING, DAYS_LEFT = 19575, 23    # uit api_check.py van vanochtend (425 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra8_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
