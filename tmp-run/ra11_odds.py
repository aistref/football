...
DAY = date(2026, 9, 11)
REMAINING, DAYS_LEFT = 19500, 20    # uit api_check.py van vanochtend (500 gebruikt deze maand)
...
json.dump(store, open("tmp-run/ra11_odds.json", "w"), ensure_ascii=False, indent=1)
print("\n" + guard.report())
