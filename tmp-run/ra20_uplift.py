...
Twee verschillen met de versie van 17 sep, allebei om hem met de analyse van vandaag te laten
...
stap die volgens Bevinding 1 van 17 sep de dubbeltelling veroorzaakt.
"""
...
json.dump({"factor": FACTOR, "gepoold": POOLED, "speeldagen": TOTAL_MD, "n": used,
          ...
          open("tmp-run/ra20_uplift.json", "w"), ensure_ascii=False, indent=1)
